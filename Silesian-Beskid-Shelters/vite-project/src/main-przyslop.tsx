...
const MainPrzyslop = () => {
  ...
  return (
    <div>
      <ResetScrollPosition />
      <Hero hero_image='assets/przyslopHero.jpg' header='Schronisko' sub_text='Przysłop'/>
          <ShelterDescription 
          shelter_image='src/assets/images/stozek.jpg' 
          image1='assets/przyslop1.jpg'
          image2='assets/przyslop2.jpg' 
