...
--
-- Host: 127.0.0.1
-- Czas generowania: 29 Mar 2023, 10:02
...
CREATE TABLE `cinema_hall` (
  ...
  `has_imax` tinyint(1) NOT NULL DEFAULT 0,
  `has_dolby_atmos` tinyint(1) NOT NULL DEFAULT 0
...
INSERT INTO `cinema_hall` (`id`, `name`, `location`, `total_rows`, `seats_per_row`, `has_imax`, `has_dolby_atmos`) VALUES
(1, 'Cinema Hall 1', 'New York', 10, 20, 1, 0);
...
INSERT INTO `seats` (`id`, `cinema_hall_id`, `row_number`, `seat_number`, `is_reserved`, `price`) VALUES
(1, 1, 1, 1, 0, '10.00'),
(2, 1, 1, 2, 0, '10.00'),
(3, 1, 1, 3, 0, '10.00'),
(4, 1, 1, 4, 0, '10.00'),
...
(1, 'admin', 'avc', 'admin@gmail.com', '$2y$10$9Kf0vEYbpRrVe4/s/2CWUeUrcQ2/PIQ12/a.yLffwr/46xhO6A9pK', '6423ef279078c', 1, '../../resources/user_images/admin@gmail.com.jpg'),
(4, 'Tomasz', 'Kowalski', 'tomasz@gmail.com', '$2y$10$774Ql1tOCGf4B5unKlHTN.nNgdMKKYmwqdpUDWrmjhsf/0middjmi', '', 0, '../../resources/user_images/default.jpg'),
...
(6, 'dsdsa', 'fdfsd', 'fsdf@gmail.com', '$2y$10$edow6J0xS2oh6kzabaL.2.YcfDMiOHc9WFj4CJzSDzMYzZeudkVo2', '', 0, '../../resources/user_images/default.jpg'),
(7, '123', '123', 'a@gmai.com', '$2y$10$PchTGB9PBTBmO5Qv0VRCoOjEKPT4q5e6MwYa.ze66LaatH/mIGjI.', '', 0, '../../resources/user_images/default.jpg'),
(8, 'ajames', 'bond', 'james@gmail.com', '$2y$10$CwpDWgdvqoD04WeXLdRK8Oprh1xeJCgevyfZYrZhQajAlzfhnXMF6', '', 0, '../../resources/user_images/default.jpg'),
(9, '567', '567', 'gmail@.com', '$2y$10$4N6LbKFLkGRsUt3iw2VEtOG7suWkKPf6Gd85oMDObPHtyT9TGCuau', '', 0, '../../resources/user_images/default.jpg'),
(10, '567', '567', 'gmail@.com', '$2y$10$4N6LbKFLkGRsUt3iw2VEtOG7suWkKPf6Gd85oMDObPHtyT9TGCuau', '', 0, '../../resources/user_images/default.jpg'),
(11, '567', '567', 'gmail@.com', '$2y$10$4N6LbKFLkGRsUt3iw2VEtOG7suWkKPf6Gd85oMDObPHtyT9TGCuau', '', 0, '../../resources/user_images/default.jpg'),
(12, '567', '567', 'gmail@.com', '$2y$10$4N6LbKFLkGRsUt3iw2VEtOG7suWkKPf6Gd85oMDObPHtyT9TGCuau', '', 0, '../../resources/user_images/default.jpg'),
(13, '567', '567', 'gmail@.com', '$2y$10$4N6LbKFLkGRsUt3iw2VEtOG7suWkKPf6Gd85oMDObPHtyT9TGCuau', '', 0, '../../resources/user_images/default.jpg'),
(14, '567', '567', 'gmail@.com', '$2y$10$4N6LbKFLkGRsUt3iw2VEtOG7suWkKPf6Gd85oMDObPHtyT9TGCuau', '', 0, '../../resources/user_images/default.jpg');
...
ALTER TABLE `seats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cinema_hall_id` (`cinema_hall_id`);
...
--
ALTER TABLE `seats`
  ADD CONSTRAINT `seats_ibfk_1` FOREIGN KEY (`cinema_hall_id`) REFERENCES `cinema_hall` (`id`);
COMMIT;
